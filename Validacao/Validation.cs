...
namespace Validacao
{
    ...
    {
        public static void AssertArgumentLessThanZero(decimal value,  string message)
        {
            if (value < 0 )
            {
        ...
        {
            Validation.AssertArgumentTrue(boolValue, message);
        }

        protected void SelfAssertStateFalse(bool boolValue, string message)
        {
            Validation.AssertStateFalse(boolValue, message);
        }

        protected void SelfAssertStateTrue(bool boolValue, string message)
        {
            Validation.AssertStateTrue(boolValue, message);
        }
    }
}
